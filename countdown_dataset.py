...
def make_prefix_v2(dp, template_type):
    target = dp['target']
    numbers = dp['nums']
    # NOTE: also need to change reward_score/countdown.py
    conv = [
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dir', default='/data1/laiyilong/OpenRLHF/data/countdown')
    ...
    with open("/data1/laiyilong/OpenRLHF/data/countdown/test.json", "w") as f:
        json.dump(test_data_list, f, indent=4)
    
    with open("/data1/laiyilong/OpenRLHF/data/countdown/train.json", "w") as f:
